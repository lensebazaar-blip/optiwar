...
DEPLOY_SET = ("acr.py", "ai_api.py", "ai_client.py", "catalogue.py", "chat.py",
              "chat_gateway.py", "contact_lens.py", "lens_minimums.py",
              ...
              "profile.py", "refunds.py", "ops_refunds.py", "cart_persist.py",
              "templates/success.html", "templates/checkout.html", "templates/lens_landing.html",
...
NEW_IN_RELEASE = ("paid_orders.py", "razorpay_events.py", "rx_powers.py",
                  ...
                  "contact_lens.py", "lens_minimums.py", "lens_cart.py",
                  "lens_prompt.py", "lens_feed.py",
